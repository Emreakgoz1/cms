            ...
            <div tab-content>
                <ul>
                    ...
                    <li>
                        ...
                        <div class="form-content">
                            <textarea name="reference_content" class="editor-short"><?= post('reference_content') ? post('reference_content') : $row['reference_content'] ?></textarea>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <div class="form-content">
                            ...
                            <div style="padding-top: 10px;">
                                <img src="<?= site_url('upload/reference/' . $row['reference_url'] . '/' . $row['reference_image']) ?>" alt="" width="400">
                            </div>
                        </div>
                    </li>
                </ul>
